...
BEGIN
    ...
    -- IF a_cid1 IS NOT NULL THEN
    INSERT INTO producttocat (prod_id, cat_id) VALUES (a_id, a_cid1);
    -- END IF;
    --
    -- IF a_cid2 IS NOT NULL THEN
    -- INSERT INTO producttocat (prod_id, cat_id) VALUES (a_id, a_cid2);
    -- END IF;
    --
    -- IF a_cid3 IS NOT NULL THEN
    -- INSERT INTO producttocat (prod_id, cat_id) VALUES (a_id, a_cid3);
    -- END IF;
    --
    -- IF a_cid4 IS NOT NULL THEN
    -- INSERT INTO producttocat (prod_id, cat_id) VALUES (a_id, a_cid4);
    -- END IF;
    --
    -- IF a_cid5 IS NOT NULL THEN
    -- INSERT INTO producttocat (prod_id, cat_id) VALUES (a_id, a_cid5);
    -- END IF;
...
;;
DELIMITER ;
-- CALL create_product(7, "PJH metal", 33, 1, 2, null, null, null);
-- CALL show_product();
